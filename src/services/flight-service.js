...
const getFlight = async (id) => {
    try {
        ...
        throw new AppError('Can\'t fetch data of the flight', StatusCodes.INTERNAL_SERVER_ERROR);
    }
}
...
const updateSeats = async (data) => {
    try {
        ...
        console.log(error);
        throw new AppError('Can\'t update data of the flight', StatusCodes.INTERNAL_SERVER_ERROR);
    }
}
